...
The mean number of juvenile hares caught annually was `r mean(juv_hares$n)` and the median was `r median(juv_hares$n)`. The most hares caught in a year was `r max(juv_hares$n)` and the least was `r min(juv_hares$n)`. 
